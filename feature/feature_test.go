...
func TestPointFromJson(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"err geojson error": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",  \"properties\": {},   \"geometry\": { \"type\": \"Point\",  \"coordinates\": [-71, 41} }",
			},
			want:    nil,
			wantErr: true,
		...
		"error Point invalid type geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\", \"properties\": {},  \"geometry\": { \"type\": \"MultiPoint\",  \"coordinates\": [-71, 41]} }",
			},
			want:    nil,
			wantErr: true,
...
func TestMultiPointFromJson(t *testing.T) {
	...
	tests := map[string]struct {
		args    args
		want    *geometry.MultiPoint
		wantErr bool
		err     error
	}{
		"error MultiPoint invalid type geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",  \"properties\": {},  \"geometry\": { \"type\": \"LineString\", \"coordinates\":  [[102, -10],[103, 1],[104, 0],[130, 4]]}}",
			},
			want:    nil,
			wantErr: true,
			err:     errors.New("invalid geometry type"),
		...
		"MultiPoint geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",  \"properties\": {},  \"geometry\": { \"type\": \"MultiPoint\", \"coordinates\":  [[102, -10],[103, 1],[104, 0],[130, 4]]}}",
			},
			want: &geometry.MultiPoint{
...
func TestPolygonFromJson(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Polygon non closed geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\", \"properties\": {},  \"geometry\": { \"type\": \"Polygon\", \"coordinates\":  [[ [102, -10],[103, 1],[104, 0], [130, 4] ]]}}",
			},
			want: &geometry.Polygon{
		...
		"Polygon - geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",\"properties\": {},  \"geometry\": { \"type\": \"Polygon\", \"coordinates\":  [[ [102, -10],[103, 1],[104, 0],[130, 4], [102, -10] ]]}}",
			},
			want: &geometry.Polygon{
				Coordinates: []geometry.LineString{{
					Coordinates: []geometry.Point{
...
func TestMultiPolygonFromJson(t *testing.T) {
	...
	tests := map[string]struct {
		args    args
		want    *geometry.MultiPolygon
		wantErr bool
		err     error
	}{
		"error MultiPolygon invalid type geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",\"properties\": {},  \"geometry\": { \"type\": \"Polygon\", \"coordinates\":  [[[ [102, 2],[103, 2],[103, 3],[102, 3],[102, 2]]],[[[100.2, 0.2],[100.8, 0.2],[100.8, 0.8],[100.2, 0.8],[100.2, 0.2]]] ]}}",
			},
			want:    nil,
			wantErr: true,
			err:     errors.New("invalid geometry type"),
		...
		"MultiPolygon geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",\"properties\": {},  \"geometry\": { \"type\": \"MultiPolygon\", \"coordinates\":  [[[ [102, 2],[103, 2],[103, 3],[102, 3],[102, 2]]],[[[100.2, 0.2],[100.8, 0.2],[100.8, 0.8],[100.2, 0.8],[100.2, 0.2]]] ]}}",
			},
			want: &geometry.MultiPolygon{
...
func TestMultiLineStringFromJson(t *testing.T) {
	...
	tests := map[string]struct {
		args    args
		want    *geometry.MultiLineString
		wantErr bool
		err     error
	}{
		"error MultiLineString invalid type geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",\"properties\": {},  \"geometry\": { \"type\": \"LineString\",   \"coordinates\":  [[[ [102, 2],[103, 2],[103, 3],[102, 3],[102, 2]]],[[[100.2, 0.2],[100.8, 0.2],[100.8, 0.8],[100.2, 0.8],[100.2, 0.2]]] ]}}",
			},
			want:    nil,
			wantErr: true,
			err:     errors.New("invalid geometry type"),
		...
		"MultiLineString geojson": {
			args: args{
				geojson: "{ \"type\" : \"Feature\",\"properties\": {},  \"geometry\": { \"type\": \"MultiLineString\",    \"coordinates\":  [[ [102, 2],[103, 2],[103, 3],[102, 3],[102, 2]], [[100.2, 0.2],[100.8, 0.2],[100.8, 0.8],[100.2, 0.8],[100.2, 0.2]]]}}",
			},
			want: &geometry.MultiLineString{
				Coordinates: []geometry.LineString{
					{
